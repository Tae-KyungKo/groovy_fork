...
/**
 * MSA 전환(study-service 추출): notification-service/groovy의 JwksKeyLocator와 동일한 패턴.
 * identity-service의 JWKS 엔드포인트에서 공개키를 가져와 캐싱하고, 실패 시 기존 캐시를 유지한다
 * (Phase 11 Resilience 패턴 재사용).
 */
@Slf4j
@Component
